  ...
  <section class="section b-orange" id="presentation">
    <div class="columns">
      <div class="column is-6">
        ...
        <p class="mt-5 c-noir is-size-5">Ici, on ne se contente pas de regarder :<br />on vit, on manipule, on interagit.</p>
        <NuxtLink to="/reservation" class="button is-secondary mt-6 is-medium">Reserver</NuxtLink>
      </div>
      <div class="column is-6">
